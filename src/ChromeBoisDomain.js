...
export default class ChromeBoisDomain extends Component {
  ...
  /* TODO: Create an event handler which, when fired, invokes the provided `toggleCycling` function with no arguments. Don't forget the click event listener that should fire it!
   */
   handleClick = (event)=>{
    toggleCycling()
   }
  ...
  render() {
    return (
      <canvas
        onMouseMove={this.handleMouseMove} onClick={this.handleClick} onKeyDown={this.handlePressKey}
        width='900'
        height='600'
        tabIndex="0">
      </canvas>
